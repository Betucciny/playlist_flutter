          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                onLongPress: () => _pageManager.removeSong(index),
              );
            },
          );
        },
...
class AddRemoveSaveSongButtons extends StatelessWidget {
  const AddRemoveSaveSongButtons({super.key});
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          FloatingActionButton(
            onPressed: () => _pageManager.addSong(context),
